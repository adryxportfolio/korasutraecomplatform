...
export default function Terms() {
  return (
    <>
      <Helmet>
        <title>Terms & Conditions - Korasutra | Legal Terms for Handcrafted Sarees</title>
        <meta 
          name="description" 
        ...
        <meta property="og:title" content="Terms & Conditions - Korasutra" />
        ...
        <meta name="twitter:title" content="Terms & Conditions - Korasutra" />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <div className="prose prose-lg max-w-none font-body text-foreground">
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground mb-4">
                  For questions about these Terms & Conditions, please contact us at customer.support@korasutra.com or call +91 74166 44554.
                </p>
              </section>
            </div>
          </div>
